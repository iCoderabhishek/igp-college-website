...
export default function ETCEDepartmentBanner() {
  ...
  useEffect(() => {
    const fetchDepartmentInfo = async () => {
      ...
      try {
        ...
        setDepartment(etceDepartmentData);
      } catch (error) {
