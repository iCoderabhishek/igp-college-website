...
export default function CSTDepartmentBanner() {
  ...
  useEffect(() => {
    const fetchDepartmentInfo = async () => {
      ...
      try {
        ...
        setDepartment(cstDepartmentData);
      } catch (error) {
